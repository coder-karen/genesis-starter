...
define( 'CHILD_THEME_NAME', 'GenesisTest' );
...
/* Below are customizations beyond the original Genesis Sample theme */

//* Customize the footer credits

function wpb_footer_creds_text () {
 $copyright = '<div class="creds"><p>Copyright &copy; ' . date('Y') . ' &middot; <a href="https://website.com/">Company Name</a></p></div>';
return $copyright;
 }
...
add_action ( 'genesis_after_header', 'bl_featured_image' );
...
function bl_featured_image() {
    ...
    if ( has_post_thumbnail() &&  is_front_page() ) {
        ...
        printf('<div class="home-featured-image"><img src="%s" alt="%s" /></div>', esc_url( $image ),
             $alt);
